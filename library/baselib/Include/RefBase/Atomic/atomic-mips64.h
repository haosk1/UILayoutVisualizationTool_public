...
#ifndef FOUNDATION_CUTILS_ATOMIC_MIPS64_H
#define FOUNDATION_CUTILS_ATOMIC_MIPS64_H
...
extern FOUNDATION_ATOMIC_INLINE
int foundation_atomic_cas(int32_t old_value, int32_t new_value, volatile int32_t *ptr)
{
    int32_t prev, status;
    do {
...
extern FOUNDATION_ATOMIC_INLINE
int foundation_atomic_acquire_cas(int32_t old_value,
                           int32_t new_value,
...
extern FOUNDATION_ATOMIC_INLINE
int foundation_atomic_release_cas(int32_t old_value,
                           int32_t new_value,
                           volatile int32_t *ptr)
{
    foundation_memory_barrier();
...
#endif /* FOUNDATION_CUTILS_ATOMIC_MIPS_H */
