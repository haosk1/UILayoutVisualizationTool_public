...
#ifndef FOUNDATION_CUTILS_ATOMIC_H
#define FOUNDATION_CUTILS_ATOMIC_H
...
int32_t foundation_atomic_add(int32_t value, volatile int32_t* addr);
int32_t foundation_atomic_and(int32_t value, volatile int32_t* addr);
int32_t foundation_atomic_or(int32_t value, volatile int32_t* addr);
 ...
 */
int32_t foundation_atomic_acquire_load(volatile const int32_t* addr);
int32_t foundation_atomic_release_load(volatile const int32_t* addr);
 ...
 */
void foundation_atomic_acquire_store(int32_t value, volatile int32_t* addr);
void foundation_atomic_release_store(int32_t value, volatile int32_t* addr);
 ...
 */
int foundation_atomic_acquire_cas(int32_t oldvalue, int32_t newvalue,
        volatile int32_t* addr);
int foundation_atomic_release_cas(int32_t oldvalue, int32_t newvalue,
        volatile int32_t* addr);
 ...
 * in a future release.
 */
#define foundation_atomic_write foundation_atomic_release_store
#define foundation_atomic_cmpxchg foundation_atomic_release_cas

#ifdef __cplusplus
} // extern "C"
#endif

#endif // FOUNDATION_CUTILS_ATOMIC_H
