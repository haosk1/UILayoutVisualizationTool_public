...
#ifndef FOUNDATION_CUTILS_ATOMIC_ARM_H
#define FOUNDATION_CUTILS_ATOMIC_ARM_H
...
extern FOUNDATION_ATOMIC_INLINE void foundation_compiler_barrier()
{
    __asm__ __volatile__ ("" : : : "memory");
}

extern FOUNDATION_ATOMIC_INLINE void foundation_memory_barrier()
{
#if FOUNDATION_SMP == 0
...
extern FOUNDATION_ATOMIC_INLINE int32_t foundation_atomic_inc(volatile int32_t *addr)
{
    return foundation_atomic_add(1, addr);
}

extern FOUNDATION_ATOMIC_INLINE int32_t foundation_atomic_dec(volatile int32_t *addr)
{
    return foundation_atomic_add(-1, addr);
}
...
#endif /* FOUNDATION_CUTILS_ATOMIC_ARM_H */
